        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <h1 className="text-2xl font-semibold text-gray-900">Pinned Links</h1>
              <span className="px-3 py-1 bg-indigo-100 text-indigo-600 rounded-full text-sm">
                {pinnedLinks.length} links
              </span>
            </div>
          </div>
        </div>
          ...
          {pinnedLinks.length === 0 ? (
            ...
            >
              ...
              <p className="mt-1 text-sm text-gray-500">
                Pin your favorite links to see them here
              </p>
            </motion.div>
          ) : (
            <motion.div
                  ...
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <div className="flex space-x-2">
                      <motion.button
                        ...
                        whileTap={{ scale: 0.9 }}
                        onClick={() => updateLink(link.id, { isPinned: false })}
